...
const float temperaturaIdeal = 26.0;
const float umidadeIdeal = 60;
const float IQAIdeal = 90.0;
...
} else if (temperatura >= temperaturaIdeal && servo2.read() != 180) {
  servo2.write(180); // Gira para 0 grau se não estiver na posição desejada
}
